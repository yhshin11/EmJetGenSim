...
if testing:
    ...
    # values['mass_X_d']   = [400, 600, 800, 1000, 1250, 1500, 2000]
    values['mass_X_d']   = [400, 600, 800, 1000, 1250]
    # values['tau_pi_d']   = [0.001, 0.1, 1, 2, 5, 25, 45, 60, 100, 150, 225, 300, 500, 1000]
    values['tau_pi_d']   = [1000]
    # values['tau_pi_d']   = [45, 225]
    # values['tau_pi_d']   = [2, 500]
    values['mass_pi_d']  = [1, 2, 5, 10]
if lifetime_testing:
    values['mass_X_d']   = [400, 1000]
    values['tau_pi_d']   = [300, 400, 500, 600, 700, 800, 900, 1000, ]
    values['mass_pi_d']  = [5]
...
tags_tau_pi_d_extra = {400 : '400', 500 : '500', 600 : '600', 700 : '700', 800 : '800', 900 : '900', 1000 : '1000', }
tags_tau_pi_d.update(tags_tau_pi_d_extra)

# for mass_X_d in values['mass_X_d']:
#     for tau_pi_d in values['tau_pi_d']:
#         for mass_pi_d in values['mass_pi_d']:
for mass_X_d, tau_pi_d, mass_pi_d in sample_list:
    ...
    kwdict_crab['datasettag'] =  'RunIISummer15GS_private_06Sep2017f'
    kwdict_crab['eventsperjob'] = 100
    kwdict_crab['totalevents'] = 30000
    kwdict_crab['lfndirbase'] = '/store/user/yoshin/EmJetMC/GENSIM-2017-09-06f/'
